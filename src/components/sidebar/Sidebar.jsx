    ...
    return (
        <div className='aside'>
            <ul >
                ...
                <NavLink to="">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill='#1f5c66' >
                ...
                <NavLink to=""> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill='#1f5c66'  ><path d="M280 128C266.7 128 256 138.7 256 152C256 165.3 266.7 176 280 176L296 176L296 209.3C188.8 220.7 104.2 307.7 96.6 416L543.5 416C535.8 307.7 451.2 220.7 344 209.3L344 176L360 176C373.3 176 384 165.3 384 152C384 138.7 373.3 128 360 128L280 128zM88 464C74.7 464 64 474.7 64 488C64 501.3 74.7 512 88 512L552 512C565.3 512 576 501.3 576 488C576 474.7 565.3 464 552 464L88 464z" /></svg>
                ...
                <NavLink to="/" end>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1f5c66" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" >
